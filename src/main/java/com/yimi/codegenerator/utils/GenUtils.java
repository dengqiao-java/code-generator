...
public class GenUtils {
    ...
    public static void generatorCode(String moduleName, String author, String email, Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip) {
        ...
        if ((moduleName == null) || ("".equals(moduleName)) || ("null".equals(moduleName))) {
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" + File.separator + moduleName + File.separator + className
                    .toLowerCase() + ".vue";
        }

        if (template.contains("add-or-update.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" + File.separator + moduleName + File.separator + className
                    .toLowerCase() + "-add-or-update.vue";
        }
